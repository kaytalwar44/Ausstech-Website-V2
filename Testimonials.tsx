...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    suburb: 'Sydney',
    quote:
      'Ausstech resolved our office IT issues quickly and professionally.',
    service: 'IT support',
  },
  {
    initials: 'SK',
  ...
  },
  {
    ...
    suburb: 'Sydney',
    quote:
      'They rebuilt our website and fixed ERP issues with great expertise.',
    service: 'Website & ERP',
  },
  {
    initials: 'MT',
  ...
  return (
    <Section id="testimonials" className="bg-white">
      <SectionHeading
        ...
        lead="Feedback from businesses and households we have supported across IT, security and NBN services."
      />
      ...
      <div className="columns-1 gap-6 md:columns-2 lg:columns-3">
        {TESTIMONIALS.map((item, index) => (
          <motion.figure
            ...
            className="mb-6 break-inside-avoid rounded-2xl border border-navy-100 bg-navy-50/50 p-6 shadow-card"
          >
            <Quote
              className="mb-4 h-6 w-6 text-electric-400"
              aria-hidden="true"
            />
            ...
            <figcaption className="mt-5 flex items-center gap-3 border-t border-navy-100 pt-5">
              <span
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-navy-900 text-xs font-bold text-white"
                aria-hidden="true"
              >
                {item.initials}
              </span>
